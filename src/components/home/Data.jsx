...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Wildan Nur Rahman
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">Mahasiswa aktif Semester 6 UIN Syarif Hidayatullah Jakarta yang mempunyai passion yang tinggi dalam dunia Teknologi.</p>
