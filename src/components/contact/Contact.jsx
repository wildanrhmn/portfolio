...
const Contact = () => {
    ...
    const sendEmail = (e) => {
      ...
      emailjs.sendForm('service_sgrkhxp', 'template_jvjnz0b', form.current, 'PktJ5eY-9lsA4zhTR')
            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">wildannurrahman30@gmail.com</span>

                        <a href="mailto:wildannurrahman30@gmail.com.com"
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">0851-7227-9467</span>

                        <a href="https://api.whatsapp.com/send?phone=6285172279467&text=Hello, more information!" target="_blank" rel="noreferrer"
                        className="contact__button">Write me{" "} <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                    </div>
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">Oreo__#8442</span>

                        <a href="https://discordapp.com/users/397654650007977985" target="_blank" rel="noreferrer" 
                        className="contact__button">Write me{" "} <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                    </div>
                </div>
            </div>
